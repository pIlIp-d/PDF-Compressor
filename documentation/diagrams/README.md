...
### Api View
![api view diagram](images/views/django_api_view.png)  
[source/views/django_api_view.puml](source/views/django_api_view.puml)  

### Download View
![download view diagram](images/views/django_download_view.png)  
[source/views/django_download_view.puml](source/views/django_download_view.puml)  

### Main View
![main view diagram](images/views/django_main_view/main_view.png)  
[source/views/django_main_view/main_view.puml](source/views/django_main_view/main_view.puml)  

![main view dropzone diagram](images/views/django_main_view/main_view_dropzone.png)  
[source/views/django_main_view/main_view_dropzone.puml](source/views/django_main_view/main_view_dropzone.puml)  

![main view processing button diagram](images/views/django_main_view/main_view_processing_button.png)  
...
![task_scheduler diagram](images/task_scheduler.png)  
