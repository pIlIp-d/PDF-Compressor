...
function init() {
    ...
    let advanced_settings = document.getElementsByName("advance_settings")[0];
    advanced_settings.onchange = function () {
        let list_of_advanced_settings = ["compression_mode", "default_pdf_dpi", "ocr_mode", "tesseract_language"]
