...
if __name__ == "__main__":
    ...
    all_args.add_argument("-o", "--output-path", required=False, help="Output path for compressed files. Default: 'filename_smaller.pdf' or 'compressed/...' for folders", default="default")
