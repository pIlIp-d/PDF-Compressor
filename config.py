...
if os.name == "nt":
    pngquant_path = os.path.join(os.path.abspath(os.path.dirname(__file__)), "compressor", "compressor_lib", "pngquant",
                                 "pngquant.exe")
    advpng_path = os.path.join(os.path.abspath(os.path.dirname(__file__)), "compressor", "compressor_lib", "advpng",
                               "advpng.exe")
